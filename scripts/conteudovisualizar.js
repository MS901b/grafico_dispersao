	var codigo_do_software = "dispersao";
	var nome_do_software = "Medidas do Corpo: Gráfico de Dispersão";
	...
	var FichaTecnica = $H({
	    ...
	    sinopse: {
	        titulo: 'Sinopse',
	        conteudo: 'Neste software, o aluno irá estudar análise exploratória de dados para duas variáveis: número do calçado e altura. A relação entre essas duas variáveis quantitativas será analisada através do chamado gráﬁco de dispersão e do coeﬁciente de correlação linear.'
	    },
	    conteudos: {
	        titulo: 'Conteúdo',
	        conteudo: 'Estatística, Interpretação de Gráﬁcos e Dados; Gráﬁcos bivariados para duas variáveis quantitativas: gráﬁco de dispersão; Coeﬁciente de correlação linear.'
	    },
	    objetivos: {
	        titulo: 'Objetivos',
	        conteudo: 'Analisar representação gráﬁca de dados estatísticos; Familiarizar o aluno com gráﬁco de dispersão e análise estatística bivariada; Utilizar o conceito de correlação linear.'
	    },
	    duracao: {
	        titulo: 'Duração',
