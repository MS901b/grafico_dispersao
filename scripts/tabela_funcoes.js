...
function criaArrayDados() {
	...
	setRespSoft('tabela_num_elementos', dados.length, "estat-dados");
	return dados;
}
...
function intiA1_P2() {
	$('mediaCalcado').update(getResp('mediaCalcado'));
	$('mediaAltura').update(getResp('mediaAltura'));
	$('medianaCalcado').update(getResp('medianaCalcado'));
	$('medianaAltura').update(getResp('medianaAltura'));
	$('desvioPadraoCalcado').update(getResp('desvioPadraoCalcado'));
	$('desvioPadraoAltura').update(getResp('desvioPadraoAltura'));
}
